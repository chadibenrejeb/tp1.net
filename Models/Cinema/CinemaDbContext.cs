...
namespace CinemaManager_Chadi.Models.Cinema;
...
public partial class CinemaDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Movie__3214EC07651759DF");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Producer__3214EC07793DC9EB");
